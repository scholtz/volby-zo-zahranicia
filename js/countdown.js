$(document).ready( function () {
    ...
    function countDownElections() {
		...
		var remaining = getRemainingTimeText(elections_start_iso,'#count-down-elections','Voľby sa už začali');
		if(remaining){
    ...
    function countDownVotingPass() {
		...
		var remaining = getRemainingTimeText(elections_by_votingpass_end_iso,'#count-down-voting-pass','Uplynul termín pre podanie žiadosti o hlasovací preukaz');
		if(remaining){
